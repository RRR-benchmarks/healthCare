...
function BillingPatient() {
  ...
  <TextField id="outlined-basic" label="Charges/Ward" size='small' type="number" variant="outlined" className='w-32' value={number1} onChange={e => {
                      setNumber1(e.target.value);
                    }} autoComplete="off" />
  <p className='text-xl font-semibold px-3 text-gray-500'>+</p>
  <TextField id="outlined-basic" label="Total Days" size='small' type="number" variant="outlined" className='w-32' value={number2} onChange={e => {
  ...
  <TextField id="outlined-basic" label=" Doctor Charge" size='small' type="number" variant="outlined" className='w-32' value={doctCharge1} autoComplete="off" onChange={e => {
                      setDoctCahrge1(e.target.value);
                    }} />
  <p className='text-xl font-semibold px-3 text-gray-500'>+</p>
  <TextField id="outlined-basic" label="Charges/Day " size='small' type="number" variant="outlined" className='w-32' value={doctCharge2} autoComplete="off" onChange={e => {
                      setDoctCahrge2(e.target.value);
                    }} />
  <p className='text-xl font-semibold px-3 text-gray-500'>=</p>
  ...
  <TextField id="outlined-basic" label="Charges/Services" size='small' type="number" variant="outlined" className='w-32' value={serviceCharge1} autoComplete="off" onChange={e => {
                      setServiceCahrge1(e.target.value);
                    }} />
  <p className='text-xl font-semibold px-3 text-gray-500'>+</p>
  <TextField id="outlined-basic" label="Total Services" size='small' type="number" variant="outlined" className='w-32' value={serviceCharge2} autoComplete="off" onChange={e => {
                      setServiceCahrge2(e.target.value);
                    }} />
  <p className='text-xl font-semibold px-3 text-gray-500'>=</p>
